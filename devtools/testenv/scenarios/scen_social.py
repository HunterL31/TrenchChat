...
from flows import (
    go_offline, go_online, invite_only_channel,
...
def f1(env):
    ...
    ch = invite_only_channel(a, [b, c, d], "f1-chan")
...
def f2(env):
    ...
    ch = invite_only_channel(a, [b, c], "f2-chan")
...
def f3(env):
    ...
    ch = invite_only_channel(a, [b, d], "f3-chan")
...
def f4(env):
    a, b, c = env.peers("A", "B", "C")
    invite_only_channel(a, [b, c], "f4-chan")
...
def f5(env):
    a, b, c = env.peers("A", "B", "C")
    invite_only_channel(a, [b, c], "f5-chan")
...
def f6(env):
    a, b, c = env.peers("A", "B", "C")
    invite_only_channel(a, [b, c], "f6-chan")
...
def f7(env):
    a, b, c = env.peers("A", "B", "C")
    invite_only_channel(a, [b, c], "f7-chan")
...
def f8(env):
    a, b, c = env.peers("A", "B", "C")
    ch = invite_only_channel(a, [b, c], "f8-chan")
...
def f10(env):
    ...
    a, b, c = env.peers("A", "B", "C")
    ch = invite_only_channel(a, [b, c], "f10-chan")
...
def f11(env):
    ...
    env.wait_alive(a)
    ch = a.create_channel("f11-invite")
