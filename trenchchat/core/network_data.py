"""
Network topology data-gathering for the network map.

Pure functions, testable without Qt -- queries the RNS instance for the
current path table and interface stats and shapes it into a node/edge graph.
See trenchchat/gui/network_map.py for the QPainter rendering side.
"""
