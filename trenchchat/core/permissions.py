...
SPEAK = "speak"
MANAGE_RELAY = "manage_relay"

ALL_PERMISSIONS = (SEND_MESSAGE, INVITE, KICK, MANAGE_ROLES, MANAGE_CHANNEL, SPEAK, MANAGE_RELAY)
...
PRESET_PRIVATE: dict[str, Any] = {
    ...
    ROLE_ADMIN: [SEND_MESSAGE, INVITE, KICK, MANAGE_ROLES, SPEAK, MANAGE_RELAY],
    ROLE_MEMBER: [SEND_MESSAGE, SPEAK],
}
...
PRESET_OPEN: dict[str, Any] = {
    ...
    ROLE_ADMIN: [SEND_MESSAGE, INVITE, KICK, MANAGE_ROLES, SPEAK, MANAGE_RELAY],
    ROLE_MEMBER: [SEND_MESSAGE, INVITE, SPEAK],
}
