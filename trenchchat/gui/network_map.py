...
# Data gathering lives in trenchchat/core/network_map.py so non-Qt frontends
# can use it; re-exported here for existing callers.
from trenchchat.core.network_map import (  # noqa: E402
    _MAX_NODES, _make_label, gather_network_data,
)
